...
public class TeamInfoController {
	...
	public void register(@RequestBody TeamInfo teamInfo) {
		...
		teamInfoEntity.setTeam(teamRepository.findById(teamId).get());
...
//	@PostMapping("/teamInfo")	// 에게 user받아서 teaminfo 만드는
